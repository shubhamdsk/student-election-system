...
builder.Services.AddScoped<IGetCurrentStudentUseCase, GetCurrentStudentUseCase>();
...
builder.Services.AddScoped<IGetVotingParticipationUseCase, GetVotingParticipationUseCase>();
