...
export const votingKeys = {
  all: ['voting'] as const,
  candidates: (electionId?: string) => [...votingKeys.all, 'candidates', electionId] as const,
  participation: (electionId?: string) => [...votingKeys.all, 'participation', electionId] as const,
