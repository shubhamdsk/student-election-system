  ...
  return (
    ...
    >
      ...
      <div className="candidate-dialog__content">
        <p className="candidate-dialog__message">
          Are you sure you want to approve {candidate?.studentFullName ?? 'this candidate'} for {candidate?.electionTitle ?? 'this election'}?
        </p>
      </div>
